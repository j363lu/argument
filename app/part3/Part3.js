...
// server location
const part3Server = "https://artsresearch.uwaterloo.ca/~dicelab/argument-backend/php/savePart3.php"; 
...
function Part3() {
  ...
  const completedHtml = `
    ...
    <br>
    <h3>Click <a href="/debriefing3" target="_blank">here</a> for more information about the study in a new tab</h3>
  `;
