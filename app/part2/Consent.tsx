  ...
  return (
    <div>
      ...
      <Container maxWidth="md">
        ...
        <p>
          You are invited to participate in a study investigating prosocial behaviours.
        </p>
        ...
        <p>
          This study is seeking to investigate what persuasive techniques work best long term. 
          This study is being conducted by a team of researchers, primarily working with Sam Johnson.
        </p>

        <p>
          This study takes place online. 
          You will first be asked to state your opinion on social issues.
        ...
        <p>
          ...
          to an open access repository or journal (i.e., the data may be publicly available). 
          Data will be completely anonymous from the beginning of the study and will be presented in aggregate 
